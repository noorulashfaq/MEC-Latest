    ...
    "dept_id":null
     ...
     const handlechange=(eve)=>{
        ...
        setIv((old)=>{
            ...
            else if(name==="sem_of_students_visited"){
              if(value=="I"||value=="III"||value=="V"||value=="VII"){
                return{
                  ...old,
                  [name]:value,
                  "sem_id":1
                }
              }else if(value=="II"||value=="IV"||value=="VI"||value=="VIII"){
                return{
                  ...old,
                  [name]:value,
                  "sem_id":2
 ...
 <div class="report-header">
    ...
    <div className="form-group">
      ...
      <select name="sem_of_students_visited" onChange={handlechange}>
        ...
        {iv.year_of_students_visited === "I" && (
        <>
          <option value="I">I</option>
          <option value="II">II</option>
        </>
        )}
        {iv.year_of_students_visited === "II" && (
          <>
            <option value="III">III</option>
            <option value="IV">IV</option>
          </>
        )}
        {iv.year_of_students_visited === "III" && (
        <>
          <option value="V">V</option>
          <option value="VI">VI</option>
        </>
        )}
        {iv.year_of_students_visited === "IV" && (
          <>
            <option value="VII">VII</option>
            <option value="VIII">VIII</option>
          </>
        )}
        {iv.year_of_students_visited === "" && (
          <>
            <option value="">Select Year of Student studying</option>
          </>
        )}
...
<label for="event_coordinator">Event Co-ordinator: </label>
 ...
 className="form-group"
    ...
    <div>
        <label style={{fontSize:"20px",color:"green"}}>Details of the Industry 1</label>
        </div>

        <div className="form-group">
        <label>Name of the Industry with Address:</label>
    ...
    <div className='form-group'>
        ...
        <div>
        <label style={{fontSize:"20px",color:"green"}}>Details of the Industry 3 (Optional)</label>
        </div>

        
     <div className="form-group">
        <label>Name of the Industry with Address (Optional):</label>
    ...
    <h1 class="recent-Articles">Details of Lodging Planned</h1>
        ...
        <div class="report-header">
    <h1 class="recent-Articles">No. of Persons (Expected)</h1>
    </div> 
       
    <div className='form-group'>
        <label>Students Count Expected</label>
        <input type='number' name='students_count' placeholder='No of expected students visited' onChange={handlechange}/>
       </div>
        
        
        <div className='form-group'>
        <label>Faculty Count Expected</label>
        <input type='number' name='faculty_count' onChange={handlechange} placeholder='No of expected Faculty Visited'/>
        </div>
...
<div>
        ...
        <div>
        <label style={{fontSize:"20px",color:"green"}}>Details of the Travels 2</label>
        </div>
        ...
        <div>
        <label style={{fontSize:"20px",color:"green"}}>Details of the Travels 3</label>
        </div>
        ...
        <div>
        <label style={{fontSize:"20px",color:"green"}}>Undertaking from Parents</label>
        </div>

        <div className="form-group">
                <label>Undertaking form submission</label>
